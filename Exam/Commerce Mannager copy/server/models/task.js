...
var ProductSchema = new mongoose.Schema({
    ...
    type: {type: String, required: [true, "Type is Required"], minlength: [3, "Name is less than 3"] },
    description: {type: String, required: [true, "Description is Required"], minlength: [3, "Name is less than 3"] },
    skills: {
        skill_1: String,
        skill_2: String,
        skill_3: String,
